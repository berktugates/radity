...
import { secondSection } from "@/constants/Questions";

export const SecondQuestionSection: React.FC = () => {
  ...
  return (
    <div className="bg-white flex flex-col">
      <div className="flex items-center justify-between bg-ByzantineBlue/10 p-4 md:px-8 md:py-4 lg:w-[619px] lg:px-4 lg:py-7 xl:w-[819px] xl:px-6 xl:py-9">
        ...
        <Image
          onClick={() => toggleCard("second")}
          src={"/svg/ChevronRight.svg"}
          className={`xl:w-9 transition-transform ${
            selectedQuestionCards.includes("second") ? "-rotate-90" : ""
          }`}
          width={36}
          height={36}
          alt="chevron-right"
